...
public class WaveManager : MonoBehaviour
{
    ...
    //spawn A
    void SpawnEnemy(GameObject enemy,GameObject spawnPoint, GameObject endPoint,GameObject leavePoint, IEntryBehaviour entryBehaviour,IMoveBehaviour moveBehaviour , ILeaveBehaviour leaveBehaviour,float curveHeight)
    {
    ...
    //spawn B
    void SpawnEnemy(GameObject enemy,GameObject spawnPoint, GameObject endPoint, GameObject leavePoint, IEntryBehaviour entryBehaviour, IMoveBehaviour moveBehaviour, ILeaveBehaviour leaveBehaviour, float curveHeight, PathCreator CurvePath)
    {
        GameObject temp = Instantiate(enemy, spawnPoint.transform.position, spawnPoint.transform.rotation);
        EnemyMove enemyMove = temp.GetComponent<EnemyMove>();
        enemyMove.endPoint = endPoint.transform;
    ...
    //spawn C
    void SpawnEnemy(GameObject enemy,GameObject spawnPoint, GameObject endPoint, GameObject leavePoint, IEntryBehaviour entryBehaviour, IMoveBehaviour moveBehaviour, ILeaveBehaviour leaveBehaviour, float curveHeight,int pathListLength,float pointWaitTime)
    {
        GameObject temp = Instantiate(enemy, spawnPoint.transform.position, spawnPoint.transform.rotation);
        EnemyMove enemyMove = temp.GetComponent<EnemyMove>();
        enemyMove.endPoint = endPoint.transform;
    ...
    IEnumerator WaveSpawn()
    {
        ...
        yield return new WaitForSeconds(0.1f);
        SpawnEnemy(enemyList[0], spawnTestList[2], endTestList[1], LeaveTestList[Random.Range(0, 2)], new EntryTypeA(),new MoveTypeC(), new LeaveTypeA(), Random.Range(-100f,100f),10,2f);
        yield return new WaitForSeconds(0.1f);
        ...
        SpawnEnemy(enemyList[0], spawnTestList[1], endTestList[2], LeaveTestList[Random.Range(0, 2)],  new EntryTypeA(), new MoveTypeA(), new LeaveTypeA(), Random.Range(-100f, 100f));
        yield return new WaitForSeconds(0.1f);
        SpawnEnemy(enemyList[0], spawnTestList[3], endTestList[1], LeaveTestList[Random.Range(0, 2)],  new EntryTypeA(), new MoveTypeC(), new LeaveTypeA(), Random.Range(-100f, 100f),10,2f);
        yield return new WaitForSeconds(0.1f);
        ...
        yield return new WaitForSeconds(0.1f);
        SpawnEnemy(enemyList[0], spawnTestList[3], endTestList[2], LeaveTestList[Random.Range(0, 2)],  new EntryTypeA(), new MoveTypeC(), new LeaveTypeA(), Random.Range(-100f, 100f),10,2f);
