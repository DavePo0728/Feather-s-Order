...
Shader "DC/DoubleCats_scene_shader "
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _R_dark_clolor2;
			float4 _R_light_color2;
			float4 _Color_speed;
			float4 _Color_uv;
			float4 _Color;
			float4 _Mask_uv;
						 ...
						 ) : SV_Target
			{
				...
				float3 temp_output_249_0 = (( lerpResult322 * _Color_power * _Color )).rgb;
				
				float2 appendResult292 = (float2(_Mask_uv.x , _Mask_uv.y));
				float2 appendResult295 = (float2(_Mask_uv.z , _Mask_uv.w));
				float2 texCoord300 = input.ase_texcoord6.xy * appendResult292 + appendResult295;
				float4 break311 = _Distort_speed1;
				float mulTime312 = _TimeParameters.x * break311.z;
				...
				float2 texCoord314 = input.ase_texcoord6.xy * appendResult310 + appendResult309;
				float2 panner315 = ( mulTime312 * appendResult313 + texCoord314);
				float3 tex2DNode287 = UnpackNormalScale( tex2D( _Distort_Tex, panner315 ), 1.0f );
				float2 appendResult290 = (float2(tex2DNode287.r , tex2DNode287.g));
				float2 Distort296 = ( appendResult290 * _Distort * _distort_direction );
				float4 tex2DNode306 = tex2D( _Mask_Tex, ( texCoord300 + Distort296 ) );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = temp_output_249_0;
				float Alpha = tex2DNode306.r;
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 appendResult292 = (float2(_Mask_uv.x , _Mask_uv.y));
				float2 appendResult295 = (float2(_Mask_uv.z , _Mask_uv.w));
				float2 texCoord300 = input.ase_texcoord3.xy * appendResult292 + appendResult295;
				float4 break311 = _Distort_speed1;
				float mulTime312 = _TimeParameters.x * break311.z;
				float2 appendResult313 = (float2(break311.x , break311.y));
				float2 appendResult310 = (float2(_Distort_uv1.x , _Distort_uv1.y));
				float2 appendResult309 = (float2(_Distort_uv1.z , _Distort_uv1.w));
				float2 texCoord314 = input.ase_texcoord3.xy * appendResult310 + appendResult309;
				float2 panner315 = ( mulTime312 * appendResult313 + texCoord314);
				float3 tex2DNode287 = UnpackNormalScale( tex2D( _Distort_Tex, panner315 ), 1.0f );
				float2 appendResult290 = (float2(tex2DNode287.r , tex2DNode287.g));
				float2 Distort296 = ( appendResult290 * _Distort * _distort_direction );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input ) : SV_Target
			{
				...
				float2 appendResult292 = (float2(_Mask_uv.x , _Mask_uv.y));
				float2 appendResult295 = (float2(_Mask_uv.z , _Mask_uv.w));
				float2 texCoord300 = input.ase_texcoord.xy * appendResult292 + appendResult295;
				float4 break311 = _Distort_speed1;
				float mulTime312 = _TimeParameters.x * break311.z;
				float2 appendResult313 = (float2(break311.x , break311.y));
				float2 appendResult310 = (float2(_Distort_uv1.x , _Distort_uv1.y));
				float2 appendResult309 = (float2(_Distort_uv1.z , _Distort_uv1.w));
				float2 texCoord314 = input.ase_texcoord.xy * appendResult310 + appendResult309;
				float2 panner315 = ( mulTime312 * appendResult313 + texCoord314);
				float3 tex2DNode287 = UnpackNormalScale( tex2D( _Distort_Tex, panner315 ), 1.0f );
				float2 appendResult290 = (float2(tex2DNode287.r , tex2DNode287.g));
				float2 Distort296 = ( appendResult290 * _Distort * _distort_direction );
				...
				surfaceDescription.Alpha = tex2DNode306.r;
...
Node;AmplifyShaderEditor.SamplerNode;287;1123.23,1479.013;Inherit;True;Property;_Distort_Tex;Distort_Tex;10;2;[NoScaleOffset];[Normal];Create;True;0;0;0;False;0;False;-1;None;1d8bcbacf6c709445a935f117f716abf;True;0;False;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;319;2898.146,-1107.176;Inherit;False;Property;_R_dark_clolor2;R_dark_clolor;4;1;[HDR];Create;True;0;0;0;False;0;False;0.1509434,0.07064492,0.03203988,0;0.2184475,1,0.1462264,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode;321;2923.801,-1276.331;Inherit;False;Property;_R_light_color2;R_light_color;3;1;[HDR];Create;True;0;0;0;False;0;False;1,0.92775,0.6462264,0;1,0.2101665,0.08018869,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode;264;3101.729,-32.03687;Inherit;False;Property;_Color;Color;6;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SamplerNode;306;3570.995,568.4688;Inherit;True;Property;_Mask_Tex;Mask_Tex;8;1;[NoScaleOffset];Create;True;0;0;0;False;0;False;-1;None;f3f3ce48026210a4da40afdcb8a71e2b;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
WireConnection;324;2;249;0
WireConnection;324;3;306;1
ASEEND*/
//CHKSM=C5812B4F5CFE1627EE73F9FC12B7C54F6081951E